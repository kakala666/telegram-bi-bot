...
from app.master_bot.handlers import ad, admin, block, broadcast, callbacks, manage, register, start
...
master_router.include_router(broadcast.router)
master_router.include_router(block.router)
master_router.include_router(ad.router)
